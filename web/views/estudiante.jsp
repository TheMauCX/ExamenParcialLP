                                    ...
                                    <div class="modal-body">
                                        <form>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="estudiante" name="rol">
                                                <label for="recipient-name" class="col-form-label">Apellido: </label>
                                                <input type="text" class="form-control" id="apellidos" name="rol">
                                                <label for="recipient-name" class="col-form-label">Correo: </label>
                                                <input type="text" class="form-control" id="correo" name="rol">
                                                <label for="recipient-name" class="col-form-label">Telefono: </label>
                                                <input type="text" class="form-control" id="telefono" name="rol">
                                                <label for="recipient-name" class="col-form-label">IdCarrera: </label>
                                                <input type="text" class="form-control" id="idcarrera" name="rol">
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="estudiante_edit" name="rol_edit">
                                                <input type="text" class="form-control" id="apellidos_edit" name="rol_edit">
                                                <input type="text" class="form-control" id="correo_edit" name="rol_edit">
                                                <input type="text" class="form-control" id="telefono_edit" name="rol_edit">
                                                <input type="text" class="form-control" id="idcarrera_edit" name="rol_edit">
                                                <input type="hidden" class="form-control" id="id_estudiante_edit" name="id_rol_edit">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="modal-footer">
